...
func (p *LikeyouRequest) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
...
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_LikeyouRequest[fieldId]), err)
SkipFieldError:
...
func (p *LikeyouRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *LikeyouRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *LikeyouRequest) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *LikeyouRequest) FastReadField4(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *LikeyouRequest) FastWrite(buf []byte) int {
	return 0
}

func (p *LikeyouRequest) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "LikeyouRequest")
	if p != nil {
...
func (p *LikeyouRequest) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("LikeyouRequest")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
		l += p.field3Length()
...
func (p *LikeyouRequest) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *LikeyouRequest) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *LikeyouRequest) fastWriteField3(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *LikeyouRequest) fastWriteField4(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *LikeyouRequest) field1Length() int {
	l := 0
...
func (p *LikeyouRequest) field2Length() int {
	l := 0
...
func (p *LikeyouRequest) field3Length() int {
	l := 0
...
func (p *LikeyouRequest) field4Length() int {
	l := 0
...
func (p *LikeyouResponse) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_LikeyouResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *LikeyouResponse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *LikeyouResponse) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *LikeyouResponse) FastWrite(buf []byte) int {
	return 0
}

func (p *LikeyouResponse) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "LikeyouResponse")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *LikeyouResponse) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("LikeyouResponse")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *LikeyouResponse) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *LikeyouResponse) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetStatusMsg() {
...
func (p *LikeyouResponse) field1Length() int {
	l := 0
...
func (p *LikeyouResponse) field2Length() int {
	l := 0
	if p.IsSetStatusMsg() {
...
func (p *ThumbListRequest) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ThumbListRequest[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ThumbListRequest) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ThumbListRequest) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ThumbListRequest) FastWrite(buf []byte) int {
	return 0
}

func (p *ThumbListRequest) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "ThumbListRequest")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
	}
...
func (p *ThumbListRequest) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("ThumbListRequest")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
	}
...
func (p *ThumbListRequest) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "user_id", thrift.I64, 1)
	offset += bthrift.Binary.WriteI64(buf[offset:], p.UserId)
...
func (p *ThumbListRequest) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "token", thrift.STRING, 2)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.Token)
...
func (p *ThumbListRequest) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("user_id", thrift.I64, 1)
	l += bthrift.Binary.I64Length(p.UserId)
...
func (p *ThumbListRequest) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("token", thrift.STRING, 2)
	l += bthrift.Binary.StringLengthNocopy(p.Token)
...
func (p *ThumbListResponse) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ThumbListResponse[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ThumbListResponse) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *ThumbListResponse) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *ThumbListResponse) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ThumbListResponse) FastWrite(buf []byte) int {
	return 0
}

func (p *ThumbListResponse) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "ThumbListResponse")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
		offset += p.fastWriteField3(buf[offset:], binaryWriter)
...
func (p *ThumbListResponse) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("ThumbListResponse")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
		l += p.field3Length()
...
func (p *ThumbListResponse) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "status_code", thrift.I32, 1)
	offset += bthrift.Binary.WriteI32(buf[offset:], p.StatusCode)
...
func (p *ThumbListResponse) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetStatusMsg() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "status_msg", thrift.STRING, 2)
		offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, *p.StatusMsg)
...
func (p *ThumbListResponse) fastWriteField3(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *ThumbListResponse) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("status_code", thrift.I32, 1)
	l += bthrift.Binary.I32Length(p.StatusCode)
...
func (p *ThumbListResponse) field2Length() int {
	l := 0
	if p.IsSetStatusMsg() {
		l += bthrift.Binary.FieldBeginLength("status_msg", thrift.STRING, 2)
		l += bthrift.Binary.StringLengthNocopy(*p.StatusMsg)
...
func (p *ThumbListResponse) field3Length() int {
	l := 0
...
func (p *ThumbServiceLikeyouArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ThumbServiceLikeyouArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ThumbServiceLikeyouArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ThumbServiceLikeyouArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *ThumbServiceLikeyouArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "Likeyou_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *ThumbServiceLikeyouArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("Likeyou_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *ThumbServiceLikeyouArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *ThumbServiceLikeyouArgs) field1Length() int {
	l := 0
...
func (p *ThumbServiceLikeyouResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ThumbServiceLikeyouResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ThumbServiceLikeyouResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ThumbServiceLikeyouResult) FastWrite(buf []byte) int {
	return 0
}

func (p *ThumbServiceLikeyouResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "Likeyou_result")
	if p != nil {
...
func (p *ThumbServiceLikeyouResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("Likeyou_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *ThumbServiceLikeyouResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
...
func (p *ThumbServiceLikeyouResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
...
func (p *ThumbServiceThumbListArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ThumbServiceThumbListArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
// for compatibility
func (p *ThumbServiceThumbListArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *ThumbServiceThumbListArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "ThumbList_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *ThumbServiceThumbListArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("ThumbList_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *ThumbServiceThumbListArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "request", thrift.STRUCT, 1)
	offset += p.Request.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
...
func (p *ThumbServiceThumbListArgs) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("request", thrift.STRUCT, 1)
	l += p.Request.BLength()
	l += bthrift.Binary.FieldEndLength()
...
func (p *ThumbServiceThumbListResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_ThumbServiceThumbListResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *ThumbServiceThumbListResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *ThumbServiceThumbListResult) FastWrite(buf []byte) int {
	return 0
}

func (p *ThumbServiceThumbListResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "ThumbList_result")
	if p != nil {
		offset += p.fastWriteField0(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *ThumbServiceThumbListResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("ThumbList_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *ThumbServiceThumbListResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "success", thrift.STRUCT, 0)
		offset += p.Success.FastWriteNocopy(buf[offset:], binaryWriter)
...
func (p *ThumbServiceThumbListResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += bthrift.Binary.FieldBeginLength("success", thrift.STRUCT, 0)
		l += p.Success.BLength()
...
func (p *ThumbServiceLikeyouArgs) GetFirstArgument() interface{} {
	return p.Request
}

func (p *ThumbServiceLikeyouResult) GetResult() interface{} {
	return p.Success
}

func (p *ThumbServiceThumbListArgs) GetFirstArgument() interface{} {
	return p.Request
}

func (p *ThumbServiceThumbListResult) GetResult() interface{} {
	return p.Success
}
