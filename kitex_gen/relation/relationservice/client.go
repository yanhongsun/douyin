...
type Client interface {
	...
	GetFollowList(ctx context.Context, req *relation.GetFollowListRequest, callOptions ...callopt.Option) (r *relation.GetFollowListResponse, err error)
...
func (p *kRelationServiceClient) GetFollowList(ctx context.Context, req *relation.GetFollowListRequest, callOptions ...callopt.Option) (r *relation.GetFollowListResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
